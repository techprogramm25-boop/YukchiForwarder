...
# ================= CONFIGURATION =================
API_TOKEN_1 = "8726416871:AAEKluMhwL7k4eP0RkchwvF_f82VQmLgc3A" # @YukchiForwarder_Bot (E'lonchi)import re
import json
import os
import logging
import asyncio
...
# Ma'lumotlarni fayldan yuklab olamiz
...
@app.get("/")
async def root():
    return {"status": "Tizim JSON xotira bilan barqaror ishlamoqda!"}
API_TOKEN_2 = "8112720689:AAFR_KtcgUYH3vBlsFZcBRj4qH3SGCwI2Zo" # @YukchiForwarderorg_Bot (Nazoratchi)
